...
<html lang="en">
  ...
  <body onload="getTime()">
				              ...
				              <div class="modal-dialog">
				                  <div class="modal-content">
				                      ...
				                      <div class="modal-body">
				                          <p class="centered"><img class="img-circle" width="80" src="cms/img/ui-sam.jpg"></p>
    ...
    <script type="text/javascript" src="cms/js/jquery.backstretch.min.js"></script>
    <script>
        $.backstretch("cms/img/login-bg.jpg", {speed: 500});
    </script>
