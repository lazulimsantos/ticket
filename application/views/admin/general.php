...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="cms/js/gritter/css/jquery.gritter.css" />
  ...
  <section id="container" >
    ...
    <script src="cms/js/jjquery-1.8.3.min.js"></script>
    ...
    <script type="text/javascript" src="cms/js/gritter/js/jquery.gritter.js"></script>
    <script type="text/javascript" src="cms/js/gritter-conf.js"></script>
