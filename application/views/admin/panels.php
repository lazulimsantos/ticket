...
<html lang="en">
  <head>
    ...
    <script src="cms/js/chart-master/Chart.js"></script>
  ...
  <section id="container" >
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							...
							<div class="white-panel pn">
								...
								<p><img src="cms/img/ui-zac.jpg" class="img-circle" width="50"></p>
								<p><b>Zac Snider</b></p>
									<div class="row">
										<div class="col-md-6">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							<div class="content-panel pn">
								<div id="profile-02">
									<div class="user">
										<img src="cms/img/friends/fr-06.jpg" class="img-circle" width="80">
										<h4>DJ SHERMAN</h4>
									</div>
								</div>
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							<div class="product-panel-2 pn">
								...
								<img src="cms/img/product.jpg" width="200" alt="">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							<div class="weather-2 pn">
								...
								<div class="row centered">
									<img src="cms/img/ny.jpg" class="img-circle" width="120">			
								</div>
								<div class="row data">
									<div class="col-sm-6 col-xs-6 goleft">
										<h4><b>16 ºC</b></h4>
    ...
    <script src="cms/js/jquery.sparkline.js"></script>

    <!--common script for all pages-->
    <script src="cms/js/common-scripts.js"></script>

    <!--script for this page-->
    <script src="cms/js/sparkline-chart.js"></script>    
