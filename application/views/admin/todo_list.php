...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="<?= base_url('cms/css/bootstrap.css')?>" rel="stylesheet">
    <!--external css-->
    <link href="<?= base_url('cms/font-awesome/css/font-awesome.css')?>" rel="stylesheet" />
    
    <!-- Custom styles for this template -->
    <link href="<?= base_url('cms/css/style.css')?>" rel="stylesheet">
    <link href="<?= base_url('cms/css/style-responsive.css')?>" rel="stylesheet">
    <link rel="stylesheet" href="<?= base_url('cms/css/to-do.css')?>">
  ...
  <section id="container" >
                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="<?= base_url('cms/img/ui-zac.jpg')?>"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="<?= base_url('cms/img/ui-divya.jpg')?>"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="<?= base_url('cms/img/ui-danro.jpg')?>"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="<?= base_url('cms/img/ui-sherman.jp')?>'"></span>
                                    <span class="subject">
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="profile.html"><img src="<?= base_url('cms/img/ui-sam.jpg')?>" class="img-circle" width="60"></a></p>
    ...
    <script src="<?= base_url('cms/js/jquery.js')?>"></script>
    <script src="<?= base_url('cms/js/bootstrap.min.js')?>"></script>
    <script class="include" type="text/javascript" src="<?= base_url('cms/js/jquery.dcjqaccordion.2.7.js')?>"></script>
    <script src="<?= base_url('cms/js/jquery.scrollTo.min.js')?>"></script>
    <script src="<?= base_url('cms/js/jquery.nicescroll.js')?>" type="text/javascript"></script>


    <!--common script for all pages-->
    <script src="<?= base_url('cms/js/common-scripts.js')?>"></script>

    <!--script for this page-->
	<script src="http://code.jquery.com/ui/1.10.3/jquery-ui.js"></script>    
    <script src="<?= base_url('cms/js/tasks.js')?>" type="text/javascript"></script>
